...
export function Icon({ name, size = 14 }: { name: IconName; size?: number }) {
  const p: Record<IconName, React.ReactNode> = {
    ...
    min: <path d="M4 8h8" strokeWidth="1.6" fill="none" strokeLinecap="round" />,
    max: <rect x="4" y="4" width="8" height="8" rx="1" fill="none" strokeWidth="1.5" />,
    close: <path d="M4 4l8 8M12 4L4 12" strokeWidth="1.6" fill="none" strokeLinecap="round" />,
